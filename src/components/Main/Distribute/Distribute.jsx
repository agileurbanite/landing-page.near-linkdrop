            ...
            <div className={mainStyle.bannerContainer}>
                <div className={distributeStyles.leftBlock}>
                    <div className={distributeStyles.banner}>
                        <StaticImage src="../../../images/Distribute.png" alt="Connect Wallet" placeholder="dominantColor" quality={90} />
                    </div>
                </div>
                <div className={distributeStyles.rightBlock}>
                    ...
                    <div className={appStyles.bannerSubTitle}>Copy each link or export all as CSV or QR codes</div>
