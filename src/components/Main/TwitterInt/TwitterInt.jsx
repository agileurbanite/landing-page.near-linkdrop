        ...
        <>
            <div className={mainStyle.bannerContainer}>
                <div className={twitStyles.leftBlock}>
                    ...
                    <div className={appStyles.bannerSubTitle}>Paras & MIntbase are using Linkdrop to run retroactive & semi-automated Twitter Campaigns</div>
                ...
                <div className={twitStyles.rightBlock}>
                    <div className={twitStyles.banner}>
                        <StaticImage src="../../../images/twitterint.png" alt="Twitter integration" placeholder="dominantColor" quality={90} />
                    </div>
                </div>
            </div>
        </>
